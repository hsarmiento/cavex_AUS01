...
<html lang="es">
	...
	<body>
		<header>
			<div id="nav-header">
			    <div id="bar-one"></div>
			    <div id="title-nav"><a href="/cavex_AUS01/home.php">Cavex Control System</a></div>
			    <div id="bar-two"></div>
			...
			<div class="menu">
				<div class="pull-center">
					<ul class="nav nav-pills">
					  <li><a href="/cavex_AUS01/home.php">Home</a></li>
					  <?php if($_SESSION['usertype'] == 1){?>
						<li><a href="/cavex_AUS01/system_calibration.php">System calibration</a></li>
					  	<li class="dropdown">
						  	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Radios<b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="/cavex_AUS01/add_radio.php">Add radio</a></li>
								<li><a href="/cavex_AUS01/radios.php">View radios</a></li>
						  	</ul> 
					  </li>
					  <?php } ?>				  
					  <li><a href="/cavex_AUS01/overview.php">Overview</a></li>
					  <li><a href="/cavex_AUS01/alarms_events.php">Alarms & events</a></li>
					  <?php if($_SESSION['usertype'] == 1){?>
						  <li class="dropdown">
					  ...
					  <?php } ?>
					  <?php if($_SESSION['usertype'] == 1){?>
					  	<li><a href="/cavex_AUS01/change_title.php">Change title</a></li>
					  <?php } ?>
					  <li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/cavex_AUS01/logout.php">Logout</a></li>
					  	</ul> 
					  </li>
					</ul>
				</div>
