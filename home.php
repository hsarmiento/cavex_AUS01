...
<div class="container container-body">
	...
	<div class="row">
		...
		<div class="span6 menu-buttons">
			...
			<?php if($_SESSION['usertype'] == 1){?>
				<p>
				  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/system_calibration.php'">System Calibration</button>
				</p>
					...
					<div id="radio_collapse" class="collapse" style="margin-bottom:10px">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/add_radio.php'">Add radio</button>
				  		<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/radios.php'">View radios</button>
				  	</div>	
			<?php } ?>
			<p>
			  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/overview.php'">Overview</button>
			</p>
			<p>
			  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/alarms_events.php'">Alarms & Events</button>
			</p>
			<?php if($_SESSION['usertype'] == 1){?>
				<p>
				  <button class="btn btn-L btn-primary" type="button" data-toggle="collapse" data-target="#user_collapse">User accounts<b class="caret caret-body"></b></button>
					<div id="user_collapse" class="collapse">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/create_user.php'">Create user</button>
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_AUS01/users.php'">View users</button>
				  	</div>
				</p>
			<?php } ?>
			</br>
